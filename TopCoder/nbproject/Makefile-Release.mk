...
${OBJECTDIR}/AlienAndHumbergers.o: AlienAndHumbergers.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlienAndHumbergers.o AlienAndHumbergers.cpp
...
${OBJECTDIR}/AlienAndHumbergers_nomain.o: ${OBJECTDIR}/AlienAndHumbergers.o AlienAndHumbergers.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AlienAndHumbergers_nomain.o AlienAndHumbergers.cpp;\
	else  \
